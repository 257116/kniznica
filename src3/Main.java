...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("10. List by Author");
            System.out.println("11. List by Genre");    
    ...
    private static void loadBookFromFile() {
        try (BufferedReader reader = new BufferedReader(new FileReader("selected_book.txt"))) {
            ...
            if (genreOrGrade.matches("\\d+")) {
                ...
                Textbook textbook = new Textbook(title, authors, yearOfPublication, isAvailable, grade);
                bookList.add(textbook);
            } else {
                Novel novel = new Novel(title, authors, yearOfPublication, isAvailable, genreOrGrade);
                bookList.add(novel);
            }
